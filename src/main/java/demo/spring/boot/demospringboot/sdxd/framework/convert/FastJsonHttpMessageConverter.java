...
import demo.spring.boot.demospringboot.sdxd.common.utils.ClassPathScanHandler;
import demo.spring.boot.demospringboot.sdxd.framework.serializer.EnumSerializer;

/**
 * Package Name: demo.spring.boot.demospringboot.sdxd.common.api.framework.convert Description: Author: qiuyangjun Create Date:2015/2/16
 */
public class FastJsonHttpMessageConverter extends com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter {
    ...
    protected void writeInternal(Object obj, HttpOutputMessage outputMessage) throws IOException,
        ...
        Set<Class<?>> calssList = handler.getPackageAllClasses("demo.spring.boot.demospringboot.sdxd.common.api", true);
