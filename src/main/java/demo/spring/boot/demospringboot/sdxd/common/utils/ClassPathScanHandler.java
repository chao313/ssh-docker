...
/**
 * Package Name: demo.spring.boot.demospringboot.sdxd.common.api.framework.utils
 * Description:
 * Author: qiuyangjun
...
//        classFilters.add("File*");
        ...
        System.out
                .println("开始递归扫描jar文件的包：demo.spring.boot.demospringboot.sdxd.common.api 下符合自定义过滤规则的类...");
