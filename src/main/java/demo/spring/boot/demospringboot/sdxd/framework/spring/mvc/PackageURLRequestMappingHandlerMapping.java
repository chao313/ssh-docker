package demo.spring.boot.demospringboot.sdxd.framework.spring.mvc;
 ...
 * 例：
 * 	packageBase: demo.spring.boot.demospringboot.sdxd.common.api.tkj.api.action
 * 	replacement: v:|_:.|, 即v替换成空字符, 下划线替换成圆点
 * 	url root: /api/
 * 	demo.spring.boot.demospringboot.sdxd.common.api.tkj.api.action.UserAction 类的RequestMapping值为:user, 某成员方法的RequestMapping值为: /getUser, 则 转换后的完整url为: /api/user/getUser
 * 	demo.spring.boot.demospringboot.sdxd.common.api.tkj.api.action.v5_1_0.UserAction 类的RequestMapping值为user, 某成员方法的RequestMapping值为: /getUser, 则 转换后的完整url为: /api/5.1.0/user/getUser
 * 
